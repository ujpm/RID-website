...
const teamData = [
  { 
    id: 1, name: "M. Shomen Abdaljabar", role: "President", image: "/images/team/1.jpg", 
  ...
  { 
    id: 2, name: "Teta Erssie", role: "Vice-President", image: "/images/team/1.jpg", 
  ...
  { 
    id: 3, name: "Methode Emmanuel Ihirwe", role: "Secretary", image: "/images/team/1.jpg", 
  ...
  { 
    id: 4, name: "Mudatenguha Leonce", role: "Treasurer", image: "/images/team/1.jpg", 
  ...
  { 
    id: 5, name: "UWIZEYIMANA Jean Pierre", role: "Research & Innovation", image: "/images/team/1.jpg", 
  ...
  { 
    id: 6, name: "Stella Fideline NIYONKURU", role: "Youth Dev & Capacity", image: "/images/team/1.jpg", 
  ...
  { 
    id: 7, name: "Mousa Suliman", role: "Executive Director", image: "/images/team/moussa.jpg", 
  ...
  { 
    id: 8, name: "Mohamed Zakaria", role: "R&D Board member", image: "/images/team/moussa.jpg", 
    bio: "Zakaria overseas the actions of reasearch and innovation office.", 
    email: "director@rid.rw", linkedin: "#" 
  },
  { 
    id: 9, name: "Yei Peter Armeto", role: "Finance and Administration Officer", image: "/images/team/moussa.jpg", 
    bio: "RID's Finance and Administration Officer.", 
    email: "director@rid.rw", linkedin: "#" 
  },
  { 
    id: 10, name: "Scientist Augustino Ayul", role: "Media and Communications Officer", image: "/images/team/moussa.jpg", 
    bio: "RID's Media and Communications Officer.", 
    email: "director@rid.rw", linkedin: "#" 
  },
  { 
    id: 11, name: "SANI MOUSSA Abdoul- Raouf", role: "Membership and Volunteer Coordinator", image: "/images/team/moussa.jpg", 
...
const advisorsData = [
  { 
    id: 1, name: "Prof. Samson A. Oyebadejo", role: "Board of Advisors", image: "/images/team/1.jpg", 
  ...
  { 
    id: 2, name: "Mr. Willian NIYONZIMA", role: "Board of Advisors", image: "/images/team/1.jpg", 
  ...
  { 
    id: 3, name: "Mr. Clement MUNYENTWARI", role: "Board of Advisors", image: "/images/team/1.jpg", 
