    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        ...
        <div className={styles.grid}>
          ...
          {/* Column 3: Get Involved (Modal Triggers) */}
          <div className={styles.links}>
            <h4 className={styles.columnTitle}>Get Involved</h4>
            <button className={styles.linkItem} onClick={() => openModal('Support')}>Support Us</button>
            <button className={styles.linkItem} onClick={() => openModal('Mentor')}>Become a Mentor</button>
            <button className={styles.linkItem} onClick={() => openModal('Member')}>Become a Member</button>
        ...
        <div className={styles.bottomBar}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
            <p className={styles.copyright} style={{ margin: 0 }}>
              © {new Date().getFullYear()} Research and Innovation for Development.
            </p>
            {/* The Badge: Small, inline, and professional */}
            ...
            >
              <Cpu size={12} strokeWidth={2.5} /> dev:JP
            </a>
          </div>
